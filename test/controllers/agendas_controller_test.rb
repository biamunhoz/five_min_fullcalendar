...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { apresentacaotelaini: @agenda.apresentacaotelaini, nome: @agenda.nome, observacao: @agenda.observacao } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { apresentacaotelaini: @agenda.apresentacaotelaini, nome: @agenda.nome, observacao: @agenda.observacao } }
